...
public class MemberLogin extends JFrame {
	...
	public MemberLogin() {
		...
		idTextFiled = new JTextField("아이디를 입력를 입력해주세요");
		idTextFiled.setText("");
		...
		pwField  = new JPasswordField("비밀번호를 입력");
		pwField.setText("");
		// sPW = pwField.getText();
		...
		searchIdBtn.setBounds(60, 80, 109, 30);
		...
		searchPwBtn.setBounds(180, 80, 118, 30);
		...
		joinBtn.setBounds(310, 80, 102, 30);
